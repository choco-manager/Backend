...
public static class DbSetExtensions {
  public static async Task<decimal> GetLeftoverFor(this DbSet<MovementItem> movementItems, Guid productId) {
    return await movementItems
      .Include(mi => mi.Product)
      .Where(mi => mi.Product.Id == productId)
