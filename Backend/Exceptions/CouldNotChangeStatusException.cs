...
public class CouldNotChangeStatusException : Exception {
  public MovementStatus OldStatus { get; init; }
  public MovementStatus NewStatus { get; init; }
  public string MovementType { get; init; }
  public Guid Id { get; init; }

  public CouldNotChangeStatusException(
    MovementStatus oldStatus,
