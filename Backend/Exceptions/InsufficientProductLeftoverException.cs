...
public class InsufficientProductLeftoverException : Exception {
  public Product Product { get; set; }
  public decimal Leftover { get; set; }
  public decimal RequestedQuantity { get; set; }

  public InsufficientProductLeftoverException(Product product, decimal leftover, decimal requestedQuantity) {
    Product = product;
    Leftover = leftover;
