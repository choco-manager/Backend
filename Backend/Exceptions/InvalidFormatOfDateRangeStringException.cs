...
public class InvalidFormatOfDateRangeStringException : Exception {
  public string? InvalidString { get; init; }

  public InvalidFormatOfDateRangeStringException(string? invalidString) {
