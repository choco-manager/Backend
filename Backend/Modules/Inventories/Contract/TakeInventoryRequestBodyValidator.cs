...
public class TakeInventoryRequestBodyValidator : AbstractValidator<TakeInventoryRequestBody> {
  public TakeInventoryRequestBodyValidator() {
    RuleForEach(i => i.Items).SetValidator(new UpdateMovementItemValidator());
  }
}