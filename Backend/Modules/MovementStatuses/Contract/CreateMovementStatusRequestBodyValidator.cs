...
public class CreateMovementStatusRequestBodyValidator : AbstractValidator<CreateMovementStatusRequestBody> {
  public CreateMovementStatusRequestBodyValidator() {
    RuleFor(ms => ms.Name).NotEmpty().NotNull();
  }
}