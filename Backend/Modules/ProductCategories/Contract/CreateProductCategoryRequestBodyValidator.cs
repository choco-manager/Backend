...
public class CreateProductCategoryRequestBodyValidator : AbstractValidator<CreateProductCategoryRequestBody> {
  public CreateProductCategoryRequestBodyValidator() {
    RuleFor(pc => pc.Name).NotEmpty().NotNull();
  }
}