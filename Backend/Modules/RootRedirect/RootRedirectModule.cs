...
namespace Backend.Modules.RootRedirect;

public class RootRedirectModule : IModule {
  public IServiceCollection RegisterModule(IServiceCollection builder) {
    return builder;
  }

  public IEndpointRouteBuilder MapEndpoints(IEndpointRouteBuilder endpoints) {
    endpoints.MapGet("/", RedirectToSwagger).ExcludeFromDescription();

    return endpoints;
  }

  private void RedirectToSwagger(HttpResponse response) {
