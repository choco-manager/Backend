...
{
    /// <inheritdoc />
    public partial class AddTablesToStoreOrders : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToBeDeliveredAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("06787c55-517b-4d26-9e54-5ae0755b65c2"), "Владимир" },
                    { new Guid("2a872129-328e-4e39-9d06-16cb9bafe6fa"), "Фурманов" },
                    { new Guid("85ae3b9a-39d7-4654-a266-2c65000cf8f1"), "Иваново" },
                    { new Guid("8ca6ebf2-bda0-4e56-9e2c-6dd77153433e"), "Приволжск" }
                });
